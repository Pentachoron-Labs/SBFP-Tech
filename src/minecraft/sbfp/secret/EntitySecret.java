...
public class EntitySecret extends Entity{
	...
	private int secretPosRotationIncrements;
	private double secretX;
	private double secretY;
	private double secretZ;
	private double secretYaw;
	private double secretPitch;
	...
	public EntitySecret(World par1World, double par2, double par4, double par6){
		this(par1World);
